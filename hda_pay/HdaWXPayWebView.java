...
//H5支付demo
public class HdaWXPayWebView extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("========",SklStaticParams.PAY_REFERER);
        extraHeaders.put("Referer",SklStaticParams.PAY_REFERER);
        ...
        webView.setWebViewClient(new WebViewClient(){
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                Log.e("============url:",url);
                    CheckResult=true;
                    if (url.startsWith("weixin://") || url.startsWith("intent://")) {
                        Intent intent;
                        try {
